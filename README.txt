...
The [terms of use] section 7 restrict tool usage for the game. Many crafting tools such as auto-clickers are prohibited by section c:
...
To circumvent this limitation it is common to remap left-click to the scroll-wheel to quickly move inventories. This method is [officially approved] by the path of exile Support. Please note that this standpoint can change at any time.
...
3. Apply closing with a cross kernel to the image.

4. Label major features in the image.
